...
import 'package:login_google/infraestructure/models/login_models.dart';

class LoginProviders extends ChangeNotifier{

  final dio = Dio();

  final usu = LoginModels(id: "7", nombre: "virgi.mor.98@gmail.com", clave: "OwO@SN4JL04v");

  List<LoginModels> usuario=[];
  ...
  Future<void> getUsuarios()async {
    ...
    final usuariosActuales = respuesta.data;
    
    usuario.addAll(loginModelsFromJson(usuariosActuales));
