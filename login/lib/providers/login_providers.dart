...
import 'package:login/domain/entities/usuario.dart';
...
class LoginProviders extends ChangeNotifier {
  ...
  void getUsuarios() async{
    ...
    final usuarioActuales = LoginModels.fromJson(respuesta.data);

    for(Usuario usuario in usuarioActuales){
      usuarios.add(LoginModels.fromJson(usuario));
    }
